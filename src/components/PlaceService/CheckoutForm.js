...
export default function CheckoutForm() {
    ...
    useEffect(() => {
        ...
        window
            .fetch("https://immense-inlet-74207.herokuapp.com/create-payment-intent", {
                method: "POST",
                headers: {
    ...
    const handleSubmit = async (ev) => {
        ...
        if (payload.error) {
            ...
            formData.append("serviceImg", newService.image.img);
            formData.append("price", newService.price);
            formData.append("email", loggedInUser.email);
            formData.append("name", loggedInUser.name);
            formData.append("description", newService.description);

            fetch("https://immense-inlet-74207.herokuapp.com/placeService", {
                method: "POST",
                body: formData,
            })
                .then((res) => res.json())
